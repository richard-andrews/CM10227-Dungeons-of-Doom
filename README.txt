...
To begin running on Linux, upload the "DoD Code1" folder to your a directory under your H drive.

Using your chosen software, navigate to the folder "DoD Code1".

To compile, enter the command "javac -d out/ src/*.java"

To run, enter the command "java -cp out/ GameLogic"
...
1. Begin running the game by compiling and running the GameLogic.java by following the instructions above.
